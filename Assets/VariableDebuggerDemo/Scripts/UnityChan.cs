    ...
    public class UnityChan : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            else if(isJumping)
            {
                ...
                if(jumpTime >= demo.GameData.JumpTime)
                {
                ...
                {
                    // 移動しながら高さを手動で変える
                    var rate = jumpTime / demo.GameData.JumpTime;
                    transform.Translate(0, 0, -demo.GameData.JumpSpeed);
                    transform.SetLocalPositionY(demo.GameData.JumpHeight * Mathf.Sin(Mathf.PI * rate));
                }
            }
        }
        ...
        public void OnSwipe(GodTouch t)
        {
            ...
            {
                motion.Play("Run");
                moveSpeed = demo.GameData.RunSpeed;
            }
            else
            {
                motion.Play("Walk");
                moveSpeed = demo.GameData.WalkSpeed;
            }
